...
public class __popup extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(__popup.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
